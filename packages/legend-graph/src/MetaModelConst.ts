...
export enum CORE_HASH_STRUCTURE {
  ...
  AWS_FIN_CLOUD_CONNECTION = 'AWS_FIN_CLOUD_CONNECTION',
  // flat-data
  FLAT_DATA = 'FLAT_DATA',
  ...
  AWS_OAUTH_AUTHENTICATION_STRATEGY = 'AWS_OAUTH_AUTHENTICATION_STRATEGY',
  AWS_PK_AUTHENTICATION_STRATEGY = 'AWS_PK_AUTHENTICATION_STRATEGY',
